...
$(document).ready(function () {
  ...
  $(".y-btn").hover(function(){
    $(this).find("span").css("letter-spacing", "2px");
  }, function(){
    $(this).find("span").css("letter-spacing", "0px");
  });
